...
$conf['template']    = 'arctic-xoops';         //see tpl directory //edit jayjay - you may want to change this to 'default-xoops' or 'masa-xoops'
$conf['fullpath']    = 0;                 //show full path of the document or relative to datadir only? 0|1
$conf['recent']      = 20;                //how many entries to show in recent
$conf['breadcrumbs'] = 10;                //how many recent visited pages to show
$conf['youarehere']  = 1;                 //show "You are here" navigation? 0|1
$conf['typography']  = 0;                 //smartquote conversion 0=off, 1=doublequotes, 2=all quotes //edit jayjay - get rid of horrid smartquotes!
$conf['htmlok']      = 0;                 //may raw HTML be embedded? This may break layout and XHTML validity 0|1
$conf['phpok']       = 0;                 //may PHP code be embedded? Never do this on the internet! 0|1
$conf['dformat']     = '%Y-%m-%d %H:%M';  //dateformat accepted by PHPs strftime() function //edit jayjay - I prefer hyphens :-)
$conf['signature']   = ' --- //[[@MAIL@|@NAME@]] @DATE@//'; //signature see wiki:config for details
$conf['toptoclevel'] = 1;                 //Level starting with and below to include in AutoTOC (max. 5)
$conf['maxtoclevel'] = 3;                 //Up to which level include into AutoTOC (max. 5)
$conf['maxseclevel'] = 3;                 //Up to which level create editable sections (max. 5)
$conf['camelcase']   = 0;                 //Use CamelCase for linking? (I don't like it) 0|1
$conf['deaccent']    = 0;                 //deaccented chars in pagenames (1) or romanize (2) or keep (0)?
$conf['useheading']  = 0;                 //use the first heading in a page as its name
$conf['refcheck']    = 1;                 //check for references before deleting media files
$conf['refshow']     = 5;                 //how many references should be shown, 5 is a good value

/* Antispam Features */

$conf['usewordblock']= 1;                 //block spam based on words? 0|1
$conf['indexdelay']  = 60*60*24*5;        //allow indexing after this time (seconds) default is 5 days
$conf['relnofollow'] = 0;                 //use rel="nofollow" for external links?
...
$conf['autopasswd']  = 0;                //autogenerate passwords and email them to user //edit jayjay
...
$conf['updatecheck'] = 0;                //automatically check for new releases? //edit jayjay - no more update messages!
...
$conf['send404']     = 1;                //Send a HTTP 404 status for non existing pages? //edit jayjay - SE friendly
...
$conf['target']['wiki']      = '';
$conf['target']['interwiki'] = '_blank'; //syntax popout
$conf['target']['extern']    = '';
$conf['target']['media']     = '';
$conf['target']['windows']   = '';
