...
function io_readFile($file,$clean=true){
  ...
  //start edit jayjay  
  if(!empty($GLOBALS['IS_LOCALE_FILE']) && $GLOBALS['IS_LOCALE_FILE'] == $file){
	  if(!empty($GLOBALS['lang']['encoding_locale'])){
		  $ret = XoopsLocal::convert_encoding($ret, $GLOBALS['lang']['encoding'], $GLOBALS['lang']['encoding_locale']);
	  }
	  unset($GLOBALS['IS_LOCALE_FILE']);
  }
  //end edit jayjay
