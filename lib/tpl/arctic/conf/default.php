...
$conf['right_sidebar_content']      = 'index,main,user,group,namespace,toc,cloud';  // defines the content of the right sidebar
$conf['right_sidebar_order']        = 'main,namespace,toc,cloud,index,user,group';  // defines the order of the right sidebar content
