...
$lang['only_admins']	        =	"Deny indexmenu syntax to no-admins.<br>Note that a page edited by a non-admin user will lost every contained indexmenu tree.";
...
$lang['skip_index']	        =	'Namespaces to skip. Full path has to be declared as a file system path. Use the Regular Expression format. Example: /(sidebar|private\/dir)/';
$lang['skip_file']		=	'Files to skip. Pages are checked with the .txt extension. Full path have to be declared as a file system path. Use the Regular Expression format. Example /(start|mydir\/start.txt)/';
